...
Veriler daha sonra aşağıdaki düzene sahip olan veya en azından sahip olabilen yapıya işaret eder:
    ...
    struct {
      ...
      /* 'age' 3 veya daha yüksek olduğunda (7.16.1 veya daha yenisi), aşağıdaki üyeler de
         mevcuttur  */
      ...
      const char *quic_version;    /* insan tarafından okunabilir quic (+ HTTP/3) kütüphanesi +
                                      sürüm veya NULL */
